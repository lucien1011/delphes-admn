...
cfg = Config("mygan",
        ...
        output_path = "/cmsuf/data/store/user/t2/users/klo/delphes-admn/mdn_slurm_201115_v2/",
        log_output_path = "/cmsuf/data/store/user/t2/users/klo/delphes-admn/mdn_slurm_201115_v2/",
        drop_column_list = [4,],
